...
5. **TODO:** A control that:
    ...
    (4)You should additionally add arp table in each host just like "arp -i eth0 -s 10.0.1.2 00:00:00:00:01:02" 
       if you want to successfully ping the hosts. For more details, you can see the topology.json of basic tutorial.
